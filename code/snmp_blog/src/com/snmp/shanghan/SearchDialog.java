...
public class SearchDialog {
    ...
    private static ArrayList<GoodItemData> mTweetDataList = new ArrayList<GoodItemData>();

    public static void showSearchDialog(final Activity activity, ArrayList<GoodItemData> tweetDataList) {
