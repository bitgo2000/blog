...
public class SnmpFile {
    public static final String SNMP_BLOG_MAIN_DIR = "blog-main";
    private static final String SNMP_BLOG_MAIN_ZIP = "blog-main.zip";
    private static final String TAG = SnmpFile.class.getSimpleName();

    public static void copyFile(Context context, boolean assetzip) {
        String path = context.getFilesDir().getAbsolutePath() + "/";
        String filename = path + SNMP_BLOG_MAIN_ZIP;
        File file = new File(filename);
        if (file.exists()) {
            LogUtils.i(TAG, "snmp file aaaaa000 ");
            return;
        }
        ...
        try {
            ...
            if (assetzip) {
                ...
                in = assetManager.open(SNMP_BLOG_MAIN_ZIP);
            } else {
        ...
        LogUtils.i(TAG, "snmp file aaaaa110");
        UnZip(path, filename);
    }
    ...
    public static void UnZip(String path, String zipFile) {
        try {
            ...
            while ((ze = zin.getNextEntry()) != null) {
                LogUtils.i(TAG, "snmp file aaaaa111 " + path + " " + ze.getName());
                if (ze.isDirectory()) {
